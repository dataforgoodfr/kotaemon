...
class PdfExtractionToMarkdownBlock(BasePdfExtractionBlock):
    ...
    Different methods could be implemented :
        - 'split_by_page' (by default), return a list of markdown, one by page \
              of the original pdf
        - 'group_all' return the entire doc in a long markdown format

    TODO implement other methods like 'split_by_chunks' with the length of \
        each chunk, or 'split_by_parts' with a logic split by part..."""
